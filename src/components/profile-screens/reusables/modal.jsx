...
const Modal = ({ children, handleClick }) => {
  return (
    ...
    >
      <div className=" h-fit relative p-4">
        <div
          onClick={() => handleClick()}
          className="absolute h-10 w-10 cursor-pointer rounded-full right-2 md:right-0 top-0 flex items-center justify-center bg-[#F5F5F5]"
        >
          <CancelIcon />
        </div>
        {children}
