  ...
  const items = [
    {
      ...
      description:
        "Effortlessly trade your favorite cryptocurrencies with our user-friendly platform and experience seamless transactions like never before with JetPay.",
    },
    {
      title: "Hassle-free gift card transactions.",
      description:
        "Say goodbye to the hassle of gift card transactions. We offer a stress-free solution to gift card trading, making the process quick and easy.",
    },
    {
      title: "Detailed and simplified trading experience",
      description:
        "Experience trading like never before with our simplified and detailed platform. Our user-friendly interface provides a seamless trading experience with ease.",
    },
    {
      title: "Maximum satisfaction in all your transactions.",
      description:
        "Enjoy a worry-free and secure trading experience with maximum satisfaction guaranteed in all your transactions.",
    },
  ];
    ...
    <div className="py-6 mt-4">
      <div className="text-center">
        ...
        <p className="mt-4 leading-relaxed text-gray-700">
          Choose JetPay for a seamless crypto trading experience with
