...
import JetSupport_chat_screen from "../../assets/jetpay-chat-screen.png";
import JetSupport_logo_on_screen from "../../assets/jetpay-logo-on-phone-screen.png";
    ...
    <Layout>
      ...
      <div className="flex flex-col lg:flex-row  h-full lg:justify-between my-2 items-center">
        <div>
          ...
          <h1 className="max-w-xl md:text-[60px] text-4xl font-bold tracking-tight mt-14 text-center md:text-start text-gray-900 sm:text-5xl">
            Download <span className="text-primary">JetPay</span> Now!
          </h1>{" "}
          <div className="flex flex-row mt-3 my-5 lg:my-0 md:mt-5 lg:mt-5 w-full gap-[9px] items-center justify-start">
      ...
      <div>
        ...
        <h2 className="max-w-xl text-4xl font-bold tracking-tight mt-14 text-center md:text-start text-gray-900 sm:text-5xl">
          What our customers say <br /> about JetPay{" "}
        </h2>{" "}
        <p className="mt-6  text-gray-700">
          Read what our satisfied customers have to say about their JetPay
          experience and discover why JetPay is the go-to solution for all
